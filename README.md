...
```bash
pdflatex Recursive_Categorical_Framework.tex  
# OR for automated builds:  
latexmk -pdf Recursive_Categorical_Framework.tex  
```
...
@article{rowell2025rcf,  
  ...
  url     = {https://github.com/daeron-bf/recursive-categorical-framework}  
}
```
